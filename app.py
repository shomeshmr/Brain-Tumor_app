...
def load_model():
    model = tf.keras.models.load_model(
        r"C:\Users\shome\Desktop\streamlit\brain_tumor_densenet_original_working_prototype.h5"
    )
    return model
...
if uploaded_file is not None:
    ...
    st.image(img, caption="Uploaded MRI", use_container_width=True, width=300)
